...
@section('content')
    ...
    <!-- Single flat accent blob, no gradient -->
    ...
    <div class="relative container mx-auto px-4 py-20 lg:py-32">
        <div class="text-center max-w-5xl mx-auto">
            <div class="inline-flex items-center px-4 py-2 bg-amber-500/10 text-amber-400 rounded-full text-sm font-semibold mb-6 border border-amber-500/30">
                <i class="fas fa-star mr-2"></i>
                Free Professional Assessment
            </div>
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight">
                Ready to Transform Your
                <span class="block text-amber-400">Business Success?</span>
            </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div class="text-center">
                    <div class="text-3xl font-black text-amber-400 mb-2">24hrs</div>
                    <div class="text-gray-300">Response Time</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-black text-amber-400 mb-2">3</div>
                    <div class="text-gray-300">Office Locations</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-black text-amber-400 mb-2">100%</div>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-20">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        <!-- Tanzania Office -->
                        <div class="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 p-8 border border-gray-100">
                            <div class="text-center">
                                <div class="w-16 h-16 rounded-2xl overflow-hidden mx-auto mb-6 ring-1 ring-gray-200">
                                    <img src="https://flagcdn.com/w160/tz.png" alt="Tanzania flag" class="w-full h-full object-cover">
                                </div>
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">Tanzania</h3>
                                <p class="text-amber-600 font-semibold mb-6">East Africa Hub</p>
                        ...
                        <div class="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 p-8 border border-gray-100">
                            <div class="text-center">
                                <div class="w-16 h-16 rounded-2xl overflow-hidden mx-auto mb-6 ring-1 ring-gray-200">
                                    <img src="https://flagcdn.com/w160/gh.png" alt="Ghana flag" class="w-full h-full object-cover">
                                </div>
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">Ghana</h3>
                                <p class="text-amber-600 font-semibold mb-6">West Africa Hub</p>
                                ...
                                <div class="space-y-4 text-left">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <i class="fas fa-phone text-gray-400 w-4"></i>
                                        <span class="text-gray-600">+233 54 011 9622</span>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        <i class="fas fa-envelope text-gray-400 w-4"></i>
                        ...
                        <div class="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 p-8 border border-gray-100">
                            <div class="text-center">
                                <div class="w-16 h-16 rounded-2xl overflow-hidden mx-auto mb-6 ring-1 ring-gray-200">
                                    <img src="https://flagcdn.com/w160/ng.png" alt="Nigeria flag" class="w-full h-full object-cover">
                                </div>
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">Nigeria</h3>
                                <p class="text-amber-600 font-semibold mb-6">Commercial Hub</p>
                                ...
                                <div class="space-y-4 text-left">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <i class="fas fa-phone text-gray-400 w-4"></i>
                                        <span class="text-gray-600">+234 81 3303 1000</span>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        <i class="fas fa-envelope text-gray-400 w-4"></i>
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                        <!-- Form Header -->
                        <div class="bg-amber-500 px-8 py-12 text-center">
                            <h2 class="text-3xl md:text-4xl font-black text-white mb-4">Get Your Free Assessment</h2>
                            <p class="text-amber-50 text-lg max-w-2xl mx-auto">
                        ...
                        <div class="p-8 md:p-12">
                            ...
                            <form method="POST" action="{{ route('contact.store') }}" class="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <div class="country-select-wrapper">
                                            <input type="text"
                                                   id="countrySearch"
                                                   class="w-full px-4 py-4 border {{ $errors->has('country') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-amber-500 focus:border-amber-500' }} rounded-xl focus:ring-2 transition-colors duration-200 bg-white cursor-pointer"
                                        ...
                                        <div id="countryDropdown" class="absolute z-50 w-full mt-2 bg-white border border-gray-300 rounded-xl shadow-xl hidden max-h-60 overflow-y-auto">
                                            ...
                                            <div id="countryOptions" class="py-2">
                                                @foreach($countries as $country)
                                                    <div class="country-option px-4 py-3 hover:bg-amber-50 cursor-pointer transition-colors duration-150" data-value="{{ $country }}">
                                                        {{ $country }}
                                                    </div>
                                                @endforeach
                                                <div class="country-option px-4 py-3 hover:bg-amber-50 cursor-pointer transition-colors duration-150" data-value="Other">
                                                    Other
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="otherCountryGroup" class="hidden">
                                    ...
                                    <input type="text" name="other_country" id="other_country" placeholder="Enter your country" value="{{ old('other_country') }}" class="w-full px-4 py-4 border {{ $errors->has('other_country') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-amber-500 focus:border-amber-500' }} rounded-xl focus:ring-2 transition-colors duration-200">
                                    @error('other_country')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="first_name" id="first_name" placeholder="Enter your first name" value="{{ old('first_name') }}" class="w-full px-4 py-4 border {{ $errors->has('first_name') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-amber-500 focus:border-amber-500' }} rounded-xl focus:ring-2 transition-colors duration-200">
                                        @error('first_name')
                                        <p class="mt-2 text-sm text-red-600 flex items-center">
                                            <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="last_name" id="last_name" placeholder="Enter your last name" value="{{ old('last_name') }}" class="w-full px-4 py-4 border {{ $errors->has('last_name') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-amber-500 focus:border-amber-500' }} rounded-xl focus:ring-2 transition-colors duration-200">
                                        @error('last_name')
                                        <p class="mt-2 text-sm text-red-600 flex items-center">
                                            <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="email" name="email" id="email" placeholder="Enter your email address" value="{{ old('email') }}" class="w-full px-4 py-4 border {{ $errors->has('email') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-amber-500 focus:border-amber-500' }} rounded-xl focus:ring-2 transition-colors duration-200">
                                        @error('email')
                                        <p class="mt-2 text-sm text-red-600 flex items-center">
                                            <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" name="phone" id="phone" placeholder="Enter your phone number" value="{{ old('phone') }}" class="w-full px-4 py-4 border {{ $errors->has('phone') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-amber-500 focus:border-amber-500' }} rounded-xl focus:ring-2 transition-colors duration-200">
                                        @error('phone')
                                        <p class="mt-2 text-sm text-red-600 flex items-center">
                                            <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <div>
                                    ...
                                    <textarea name="message" id="message" rows="6" placeholder="Describe your project, goals, challenges, or how we can help you succeed..." class="w-full px-4 py-4 border {{ $errors->has('message') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-amber-500 focus:border-amber-500' }} rounded-xl focus:ring-2 transition-colors duration-200 resize-none">{{ old('message') }}</textarea>
                                    @error('message')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <!-- Submit Button -->
                                <div class="pt-4">
                                    <button type="submit" class="w-full bg-amber-500 hover:bg-amber-600 text-white font-black py-5 px-8 rounded-xl focus:ring-4 focus:ring-amber-200 transition-colors duration-300 shadow-sm hover:shadow-md text-lg">
